/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 88f8bbca05e4758f4ade1b8ade92b16d)
// Runtime types generated with workerd@1.20250617.0 2025-06-21 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WHITELIST: KVNamespace;
		DISCORD_APPLICATION_ID: string;
		DISCORD_PUBLIC_KEY: string;
		DISCORD_TOKEN: string;
		DISCORD_GUILD_ID: string;
		DISCORD_WHITELISTED_ROLE: string;
		MINECRAFT_IP: string;
		MINECRAFT_RCON_PORT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_TOKEN" | "DISCORD_GUILD_ID" | "DISCORD_WHITELISTED_ROLE" | "MINECRAFT_IP" | "MINECRAFT_RCON_PORT" | "MINECRAFT_RCON_PASSWORD">> {}
}
